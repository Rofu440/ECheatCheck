...
import org.rofu.echeatcheck.core.core.listener.MovementListener;
import org.rofu.echeatcheck.core.core.listener.PlayerListener;
...
public final class ECheatCheck extends JavaPlugin {
    ...
    private void registerListeners() {
        getServer().getPluginManager().registerEvents(new MovementListener(checkManager), this);
